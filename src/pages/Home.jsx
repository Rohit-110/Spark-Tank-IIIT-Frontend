...
const Home = () => {
  ...
  return (
    <>
        ...
        Welcome to Spark Tank Bits Hyd, where entrepreneurs can seamlessly pitch their innovative ideas. Our platform connects visionaries with investors, providing the tools and resources needed for successful presentations. Ignite your entrepreneurial journey with us and turn your ideas into reality.
        </div>
